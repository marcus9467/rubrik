...
.SYNOPSIS
This script will onboard Microsoft 365 OneDrive users for protection based on a provided CSV file, mapping each user to their RSC ID and assigning SLA Domains in batches. 
...
.EXAMPLE
./OnboardOneDrive.ps1 -assignSLas -OrgId $orgId -ServiceAccountJson $serviceAccountJson -SlaId "bc0ae305-159b-47c8-8588-9a30f3868af2" -csv $CSV -batched
